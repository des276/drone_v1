      ...
      echo '<div class="ot-metabox-wrapper">';
        ...
        foreach ( $this->meta_box['fields'] as $field ) {
          ...
          echo '<div class="format-settings">';
            ...
            {
                case 'text' : {
                    echo '<input type="text" name="'.$_args['field_id'].'" id="'.$_args['field_id'].'" value="'.$_args['field_id'].'" size="80" />';
                    break;
                }
                case 'select' : {
                    echo '<select name="' .$_args['field_id']. '" id="' .$_args['field_id']. '" class="">';
...
if ( ! function_exists( 'ot_display_by_type' ) ) {
  ...
  function ot_display_by_type( $args = array() ) {
    ...
    $function_name_by_type = $args['type'];
    ...
    if ( function_exists( $function_name_by_type ) ) {
      ...
      echo esc_attr($function_name_by_type);
