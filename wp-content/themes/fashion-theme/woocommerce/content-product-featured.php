...
<div class="row">
	<div class="large-5 small-5 columns">
		<a href="<?php the_permalink(); ?>">
      		...
      		<div class="quick-view fa fa-search tip-top" data-prod="<?php echo $post->ID; ?>" data-tip="Quick View"></div>
         		<div class="main-img"><?php echo get_the_post_thumbnail( $post->ID, 'shop_catalog') ?></div>
