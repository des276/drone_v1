...
$of_options[] = array( 	"name" 		=> "Pre footer image",
				"desc" 		=> "Insert image link for pre footer",
				"id" 		=> "pre_footer",
				"std" 		=> get_template_directory_uri()."/images/banner-ad-1.jpg",
				"type" 		=> "text"
);
...
$of_options[] = array( 	"name" 		=> "Footer bottom left content (copyright text)",
				...
				"id" 		=> "footer_left_text",
				"std" 		=> "Copyright 2015 Leebros. All Right Reserved.",
				"type" 		=> "text"
);
...
$of_options[] = array( 	"name" 		=> "Footer bottom right content",
				...
				"std" 		=> get_template_directory_uri()."/images/payment.png",
				"type" 		=> "text"
);
...
$of_options[] = array( 	"name" 		=> "Heading fonts (H1, H2)",
						...
						"preview" 	=> array(
										"text" => "<strong>Fashion</strong> <br><span style='font-size:60%!important'>UPPERCASE TEXT</span>", 
										"size" => "30px" 
						),
...
$of_options[] = array( 	"name" 		=> "Animation for display products",
						"desc" 		=> "",
						"id" 		=> "animated_products",
						"desc"      => "Enable or Disable display animation products.",
						"std" 		=> 1,
						"type" 		=> "checkbox"
);
...
$of_options[] = array( 	"name" 		=> "Popup Background",
						"desc" 		=> "Insert popup background. The popup size is 700x350",
						"id" 		=> "pp_background",
